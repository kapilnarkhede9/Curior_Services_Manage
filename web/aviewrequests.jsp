...
<script src="js/modernizr.js"></script>
    ...
    <script>alert('Request Sent to Courier Person..!');</script>
    <%}%>
...
<body>
    ...
    <li class="current-menu-item"><a href="aviewrequests.jsp">View Requests</a></li>
    ...
    String sql1 = "select * from requests where status = 'Pending'";
    ...
    %>
    <center>
        <p><font size="5" >View User Requests </font></p>
    <style>
        th{
            color: #298bff;
        }
    ...
    <tr>
        ...
        <td><a href="send.jsp?id=<%=rs.getString(1)%>&location=<%=rs.getString("location")%>"><button type="button">Send</button></a></td>
