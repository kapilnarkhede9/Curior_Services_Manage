...
<body>
    ...
    <li><a href="dviewrequest.jsp">View Admin Requests</a></li>
    <li class="current-menu-item"><a href="updatestatus.jsp">Update Status</a></li>
    ...
    String sql1 = "select * from requests where status = 'Approved' and location = '"+location+"' ";
    Statement st1 = connection.createStatement();
    ResultSet rs1 = st1.executeQuery(sql1);
    if(rs1.next()){
    
    String sql = "select * from requests where status = 'Approved' and location = '"+location+"' ";
    Statement st = connection.createStatement();
    ResultSet rs = st.executeQuery(sql);

    %>
    <center>
        <p><font size="5" >Update Courier Status </font></p>
    <style>
        th{
            color: #298bff;
        }
    ...
    <tr>
        ...
        <td><a href="update.jsp?id=<%=rs.getString(1)%>&destination=<%=rs.getString("destination")%>&email=<%=rs.getString("email")%>"><button type="button">Update Status</button></a></td>
