...
<body>
    ...
    <li class="current-menu-item"><a href="adddelpersons.jsp">Add Delivery Person</a></li>
    ...
    <p align="justify">
    <center><p><font color="red" size="5">Add Delivery Persons</font></p>
    <form name="myform" action="adddelpersonsact.jsp" method="post" id="" >
    <table width="371">
    <tr>
